...
/// This files defines the widget that is used to show a comment when someone
/// comments on the participant response
          ...
          children: [
            ...
            widget.comment.participantUID == widget.participantUID
              ...
              children: [
                ...
                : widget.comment.commentType == 'moderatorComment' ? Row(
              children: [
                Expanded(
                  // child: Text(
                  //   _commentStatement,
