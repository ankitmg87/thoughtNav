...
/// This widget is used to show the moderator's comment notification to the participant
    ...
    return InkWell(
      ...
      onTap: (){
        Navigator.of(context).popAndPushNamed(PARTICIPANT_RESPONSES_SCREEN, arguments: {
          'topicUID' : moderatorCommentNotification.topicUID,
          'questionUID' : moderatorCommentNotification.questionUID,
        });
      },
      child: Row(
