...
class ClapNotificationWidget extends StatelessWidget {
  ...
  const ClapNotificationWidget({Key key, this.clapNotification})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var date = formatDate.format(clapNotification.notificationTimestamp.toDate());
    var time = formatTime.format(clapNotification.notificationTimestamp.toDate());
          ...
          imageBuilder: (context, imageProvider){
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _CLAP_NOTIFICATION_WIDGET_BACKGROUND_COLOR.withOpacity(0.3),
              ),
              child: Image(
                image: imageProvider,
                width: 24.0,
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: clapNotification.displayName,
                      style: TextStyle(
