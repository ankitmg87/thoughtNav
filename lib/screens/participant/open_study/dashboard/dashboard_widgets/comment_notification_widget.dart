...
class CommentNotificationWidget extends StatelessWidget {
  ...
  const CommentNotificationWidget({Key key, this.commentNotification})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var date = formatDate.format(commentNotification.notificationTimestamp.toDate());
    var time = formatTime.format(commentNotification.notificationTimestamp.toDate());
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: commentNotification.displayName,
                      style: TextStyle(
